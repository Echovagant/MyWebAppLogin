        ...
        <div class="max-w-2xl mx-auto bg-white rounded-xl shadow-2xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-6 py-4">
                <div class="flex items-center">
                    ...
                    <h1 class="text-2xl font-bold">编辑竞赛</h1>
                </div>
            </div>
            ...
            <div class="p-6">
                ...
                <form action="admin" method="post">
                    <input type="hidden" name="action" value="updateCompetition">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="mb-5">
                            ...
                            <select id="type" name="type" required 
                                ...
                                <option value="编程类" ${competition.type == '编程类' ? 'selected' : ''}>编程类</option>
                                <option value="设计类" ${competition.type == '设计类' ? 'selected' : ''}>设计类</option>
                                <option value="数学类" ${competition.type == '数学类' ? 'selected' : ''}>数学类</option>
                                <option value="英语类" ${competition.type == '英语类' ? 'selected' : ''}>英语类</option>
                                <option value="机器人" ${competition.type == '机器人' ? 'selected' : ''}>机器人</option>
                                <option value="其他" ${competition.type == '其他' ? 'selected' : ''}>其他</option>
                            </select>
                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <select id="level" name="level" required 
                                ...
                                <option value="校级" ${competition.level == '校级' ? 'selected' : ''}>校级</option>
                                <option value="市级" ${competition.level == '市级' ? 'selected' : ''}>市级</option>
                                <option value="省级" ${competition.level == '省级' ? 'selected' : ''}>省级</option>
                                <option value="国家级" ${competition.level == '国家级' ? 'selected' : ''}>国家级</option>
                                <option value="国际级" ${competition.level == '国际级' ? 'selected' : ''}>国际级</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <select id="formType" name="formType" required 
                            ...
                            <option value="个人" ${competition.formType == '个人' ? 'selected' : ''}>个人</option>
                            <option value="团体" ${competition.formType == '团体' ? 'selected' : ''}>团体</option>
                            <option value="个人/团体均可" ${competition.formType == '个人/团体均可' ? 'selected' : ''}>个人/团体均可</option>
                        </select>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="mb-5">
                            ...
                            <input type="date" id="startDate" name="startDate" 
                                   value="<fmt:formatDate value='${competition.startDate}' pattern='yyyy-MM-dd' />" required 
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition duration-300">
                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <input type="date" id="endDate" name="endDate" 
                                   value="<fmt:formatDate value='${competition.endDate}' pattern='yyyy-MM-dd' />" required 
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition duration-300">
                        </div>
                    </div>
